      ...
      <div className="p-6 flex flex-col flex-grow text-center">
        ...
        <div className="mt-auto flex flex-col items-center gap-4">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link href="#" className="w-10 h-10 rounded-full  flex items-center justify-center text-charcoal/80 hover:bg-brand hover:text-white transition-all   border border-neutral-200">
            ...
            <Link href="https://www.instagram.com/propertyjarrealtyltd_?igsh=NWY5aTU1ZGFuc2hh" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full  flex items-center justify-center text-charcoal/80 hover:bg-brand hover:text-white transition-all border border-neutral-200 ">
