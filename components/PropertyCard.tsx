...
interface PropertyCardProps {
  ...
  onDownloadClick?: (property: Property) => void;
}

const PropertyCard = ({ property, displayPrice, displayPricingOptions, currency, onDownloadClick }: PropertyCardProps) => {
      ...
      <div className="p-6 flex flex-col flex-grow text-center">
        ...
        <div className="mt-auto flex flex-col gap-4">
          <a
            ...
            className="flex items-center justify-center gap-2 bg-[#14b8a6] text-white py-3 rounded-full font-bold hover:bg-[#0d9488] transition-all shadow-md active:scale-95 text-sm uppercase tracking-widest"
          >
          ...
          {property.brochureUrl && onDownloadClick && (
            <button
              onClick={() => onDownloadClick(property)}
              className="flex items-center justify-center gap-2 bg-charcoal text-white py-3 rounded-full font-bold hover:bg-black transition-all shadow-md active:scale-95 text-xs uppercase tracking-widest w-full"
            >
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <a href="https://www.instagram.com/propertyjarrealtyltd_?igsh=NWY5aTU1ZGFuc2hh" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-charcoal hover:bg-brand hover:text-white transition-all shadow-sm">
