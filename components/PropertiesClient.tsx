...
function FilterSelect({
  ...
  return (
    <div className="flex flex-col gap-1 lg:gap-1.5">
      <label htmlFor={id} className="font-normal text-gray-800 text-sm md:text-base">
        {label}
      </label>
      <div className="relative group flex items-center">
        ...
        <select
          ...
          className="appearance-none w-full bg-white border border-gray-100 text-charcoal text-sm font-medium rounded-xl lg:rounded-2xl px-2 lg:pl-11 lg:pr-10 py-2.5 lg:py-3.5 focus:outline-none focus:border-brand focus:ring-4 focus:ring-brand/5 transition-all shadow-sm cursor-pointer hover:border-brand/50"
        >
          {options.map((opt) => (
      ...
      <section className="bg-off-white pt-16 pb-8">
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <Link
              href="/campaign"
              className="border-b-2 border-brand px-4 py-2 w-fit text-brand font-semibold text-sm hover:opacity-80 transition-all active:scale-95 whitespace-nowrap hover:cursor-pointer hover:text-white hover:bg-brand hover:rounded-lg"
            >
              Investor Campaign →
            </Link>
          </div>
