    ...
    <div className="min-h-screen bg-off-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <Link
            href="/"
            className="text-3xl font-bold text-charcoal tracking-tighter"
          >
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-10 shadow-xl">
          <h1 className="text-2xl font-bold text-charcoal mb-2 tracking-tight">
            Welcome back
          </h1>
          <p className="text-gray-400 text-sm mb-8">
            Sign in to manage PropertyJar Realty.
          </p>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-charcoal text-sm placeholder:text-gray-300 focus:outline-none focus:border-brand transition-colors pr-12"
                />
                <button
                  type="button"
