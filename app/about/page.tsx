          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-12 items-center">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 space-y-1">
                ...
                <p className="bg-white rounded px-2 py-1 uppercase font-medium text-brand text-xs tracking-widest w-fit">Founder & CEO</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="pt-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="/contact"
                  className="inline-block bg-brand text-white px-10 py-4 rounded-sm font-bold text-sm tracking-widest hover:bg-brand-hover transition-all shadow-lg"
                >
                  Work With Us
                </motion.a>
              </div>
      ...
      <section className="py-16 bg-white overflow-hidden">
        <div className="container mx-auto">
          <motion.div
            ...
            className="mb-8 px-6"
          >
            <h2 className="text-3xl md:text-4xl font-medium text-neutral-800 tracking-tight uppercase mb-4">
              WE <span className="italic font-light serif text-brand"> SPECIALIZE IN</span>
            </h2>
              ...
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex gap-4">
                  {[
                    {
                      title: 'Land Banking',
                      icon: <Landmark className="w-6 h-6 text-brand" size={24} strokeWidth={1.5} />,
                      desc: 'Strategic acquisition of high-growth land in developing corridors.'
                    },
                    {
                      title: 'Smart Estates',
                      icon: <Zap className="w-6 h-6 text-brand" size={24} strokeWidth={1.5} />,
                      desc: 'Modern, tech-integrated communities designed for the next generation.'
                    },
                    {
                      title: 'Luxury Apartments',
                      icon: <Crown className="w-6 h-6 text-brand" size={24} strokeWidth={1.5} />,
                      desc: 'Bespoke urban living spaces featuring world-class amenities.'
                    },
                    {
                      title: 'Off-plan Opportunities',
                      icon: <Compass className="w-6 h-6 text-brand" size={24} strokeWidth={1.5} />,
                      desc: 'Exclusive early-access to the city\'s most anticipated projects.'
                    }
                  ].map((item) => (
                    <div
                      key={item.title}
                      className="min-w-[280px] md:min-w-[320px] bg-off-white p-6 rounded-[10px] border border-gray-100 shadow-sm hover:shadow-xl transition-all group/card relative overflow-hidden select-none"
                    >
                      <div className="absolute top-0 left-0 w-full h-1 bg-brand opacity-0 group-hover/card:opacity-100 transition-opacity" />
                      <div className="mb-6 group-hover/card:scale-110 transition-transform duration-500 origin-left bg-brand/5 p-2 w-fit rounded-2xl flex items-center justify-center">
                        {item.icon}
                      </div>
                      <h3 className="text-lg font-semibold text-charcoal mb-3 group-hover/card:text-brand transition-colors tracking-tight">
                        {item.title}
                      </h3>
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-charcoal tracking-tight mb-0.5">{item.title}</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-center max-w-4xl mx-auto border-t border-gray-50"
          >
